...
CREATE TABLE `pilot` (
  ...
  `delivery_history` int DEFAULT NULL,
  `assigned_drone_id` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`account`),
  UNIQUE KEY `license_id_UNIQUE` (`license_id`),
  CONSTRAINT `FK7f79o6byn9b4m6cm9yrm7nadq` FOREIGN KEY (`account`) REFERENCES `employee` (`account`),
  CONSTRAINT `fk_pilot_account` FOREIGN KEY (`account`) REFERENCES `user` (`account`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `pilot` VALUES ('ffig8','panam_10',34,'1'),('ggrape17','twa_21',31,'1'),('testPilot','panam_11',36,'2');
