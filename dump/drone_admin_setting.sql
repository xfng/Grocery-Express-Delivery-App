...
CREATE TABLE `admin_setting` (
  `system_id` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL,
  `limit_count` int DEFAULT NULL,
  `limit_period` int DEFAULT NULL,
...
INSERT INTO `admin_setting` VALUES ('admin',10,10,90,'abc123');
